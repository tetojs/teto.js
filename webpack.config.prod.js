...
module.exports = {
  ...
  module: {
    loaders: [{
      ...
      test: /\.s?css$/,
      loader: ExtractTextPlugin.extract('style', 'css?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!sass?includePaths[]=' + __dirname + 'node_modules/compass-mixins/lib!postcss'),
      exclude: /node_modules/,
      include: __dirname
    }, {
      test: /\.handlebars$/,
